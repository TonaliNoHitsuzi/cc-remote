...
## 本项目是什么
手机飞书远控本机 opencode agent 的部署工程。方案已定稿并经用户逐条确认（见 docs/01-方案定稿.md），**当前状态：M0–M2 已完成、生产容器上线、已开源（github.com/TonaliNoHitsuzi/cc-remote）**。平台为 QQ 机器人（变更史见 01 文档第 0 节），上游补丁 PR #1789/#1790/#1791 提交中。剩余：M3 权限细化 / M5 Dashboard / M6 收尾。
